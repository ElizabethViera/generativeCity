...
function generateDuckScene() {
  ...
  function addDuckBox(
    pos: THREE.Vector3,
    {
      box = new THREE.Color("rgb(255,255,255)"),
      bottom = new THREE.Color("rgb(255, 255, 255"),
    }
  ) {
    const size = 8;
    const index = geometry.vertices.length;
  ...
  addDuckBox(new THREE.Vector3(-4, 9, 8), {
    box: new THREE.Color(0x92672c),
    bottom: new THREE.Color(0x004400),
  });
...
//           right: new THREE.Color(color),
//           left: new THREE.Color(color),
//         });
//       }
//       x += randChoose(dirs);
//       z += randChoose(dirs);
...
// //             left: new THREE.Color(sideColor),
// //             right: new THREE.Color(sideColor),
// //           });
// //         }
// //       }
// //     }
...
// //         const pb = randBetween(240, 250);
// //         const pinkColor = "rgb(" + pr + ", " + pg + ", " + pb + ")";
// //         addCube(new THREE.Vector3(x, treeTopHeight, z), {
// //           top: new THREE.Color(pinkColor),
// //           left: new THREE.Color(pinkColor),
// //           right: new THREE.Color(pinkColor),
// //         });
// //       }
// //     }
// //   }
...
async function draw(container: HTMLElement) {
  ...
  ducky.position.z = 12;
  ducky.position.y = 4;
  ducky.rotateOnAxis(new THREE.Vector3(0, 1, 0), -0.7);

  ducky.traverse((obj) => {
    if (obj instanceof THREE.Mesh) {
      obj.geometry.computeVertexNormals();
      obj.material = new THREE.MeshToonMaterial({
        color: new THREE.Color(0x20292f),
      });
    }
  });
